...
public class ProductController {
    ...
    public ProductResponse getById(@PathVariable Long id) { return productService.getById(id); }
    ...
    public ProductResponse update(@PathVariable Long id, @Valid @RequestBody ProductRequest request) { return productService.update(id, request); }
